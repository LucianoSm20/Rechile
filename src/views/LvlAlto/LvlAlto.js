...
import PreguntaAlto from '../Preguntas/PreguntaAlto.js'
...
const LvlAlto = () => {
   ...
   // let starsRef = storage.refFromURL('gs://rechile-28a41.appspot.com/Antofagasta.svg.png');
    ...
    const getDatos = async () => {
        await db.collection("lvlalto1").onSnapshot((querySnapshot) => {
            const docs = [];
    ...
    function showPregunta(){
        if (ready){
            ...
            if (datos !== undefined) {
                return(
                    <PreguntaAlto setRespuesta = {setRespuesta} datos = {datos[i]} />
        ...
        <div className={classes.bg}>
            <div className={classes.section1}>
                ...
                <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
                    ...
                    Instrucciones  de uso para Nivel Alto
                    </DialogTitle>
                    ...
                    <Typography gutterBottom>
                        ...
                        clima, producción primaria, producción secundaria y actividad comercial
                ...
                <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={openFinal}>
                    <DialogTitle id="customized-dialog-title" onClose={handleClose}>
                    Juego finalizado, tus medallas por región han sido: 
                    </DialogTitle>
                    <DialogContent dividers>
                    <Typography gutterBottom>
