                      ...
                      <CardContent>
                          ...
                          <Accordion>
                            <AccordionSummary
                              ...
                              id="panel1a-header"
                            >
                              <Typography className={classes.heading}>Clima de la región</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                              <Typography>
                                {props.datos.clima}
                          ...
                          <Accordion>
                            <AccordionSummary
                              ...
                              id="panel1a-header"
                            >
                              <Typography className={classes.heading}>Produccion primaria</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                              <Typography>
                                {props.datos.produccion_primaria}
                              </Typography>
                            </AccordionDetails>
                          </Accordion>
                          ...
                          <Accordion>
                            <AccordionSummary
                              ...
                              id="panel1a-header"
                            >
                              <Typography className={classes.heading}>Produccion secundaria</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                              <Typography>
                                {props.datos.produccion_secundaria}
                              </Typography>
                            </AccordionDetails>
                          </Accordion>
                          ...
                          <Accordion>
                            <AccordionSummary
                              ...
                              id="panel1a-header"
                            >
                              <Typography className={classes.heading}>Actividad comercial</Typography>
                            </AccordionSummary>
                            <AccordionDetails>
                              <Typography>
                                {props.datos.actividad_comercial}
                              </Typography>
                            </AccordionDetails>
                          </Accordion>
